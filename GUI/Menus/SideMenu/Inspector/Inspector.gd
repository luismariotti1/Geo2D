...
onready var vertex_tree = get_node("VBoxContainer/PanelContainer2/ScrollContainer/VBoxContainer/HBoxVertex/Tree")
onready var center_tree = get_node("VBoxContainer/PanelContainer2/ScrollContainer/VBoxContainer/HBoxCenter/Tree")
